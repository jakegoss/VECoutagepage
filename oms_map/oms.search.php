<!-- This is back up of orginal search build -->
...
<h5 style="text-align: center">Look up your outage</h5>
<?php
...
echo "<form action='".$_SERVER["PHP_SELF"]."' style='background-color: #ffffff; height: 25px;' method='post'>Account Number: <input size=20 name=search style='border: 1px solid black;'> <input type=submit value='Search'> </form>\n";
