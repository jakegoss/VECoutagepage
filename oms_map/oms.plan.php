...
<h4 style="text-align: center;">COOP Planned Outages</h4>
<Table class="outage" border='0' cellspacing='1' cellpadding='3' width=100%><thead> 
<tr>
<th bgcolor='#e47322'><font color="white" size=2>Town</font></th>
<th bgcolor='#e47322'><font color="white" size=2>#M</font></th>
<th bgcolor='#e47322'><font color="white" size=2>Time Off</font></th>
<th bgcolor='#e47322'><font color="white" size=2>Time on</font></th>
<th bgcolor='#e47322'><font color="white" size=2>Estimated<br/>Restoration Time</font></th>
<th bgcolor='#e47322'><font color="white" size=2>Cause</font></th>
<th bgcolor='#e47322'><font color="white" size=2>Desc.</font></th>
<th bgcolor='#e47322'><font color="white" size=2>Ticket#</font></th></tr>
</thead>

<?php

$query = 'SELECT * FROM planned_outages where `on` != "" and numout > 0;';
...
for($x = 0 ; $x < mysqli_num_rows($resultID) ; $x++){
   $row = mysqli_fetch_assoc($resultID);
     ...
     <td bgcolor='#f5f5f5'><font size=2>$numout</font></td>
     <td><font size=2>$off</font></td>
     <td bgcolor='#f5f5f5'><font size=2>$on</font></td>
     <td><font size=2>$etr</font></td>
     <td bgcolor='#f5f5f5'><font size=2>$cause</font></td>
     <td><font size=2>$desc</font></td></tr>
     <td bgcolor='#f5f5f5'><font size=2>$tk</font></td></tr>\n";
	 }
echo "</table>&nbsp;\n";
if (mysqli_num_rows($resultID) == 0) {
   echo "<b><p style='text-align: center;'>There are no planned outages at this time.</p></b><br>\n";
}
echo "</center>";
