...
echo "<p><font size=2>Enter your account number to get the estimated restoration time for your outage.<br>If you do not know your account number, please call 1-800-832-2667.</font></p><br>\n";
...
if ($search > 1) {
	 ...
	 if (mysqli_num_rows($resultID1) == 0) {
		 ...
		 echo "<tr><th bgcolor='#0082c8' align=center ><font size=1>Account</font></th><th bgcolor='#0082c8' align=center><font   size=1>Estimated<br>Restoration Time</font></th><th bgcolor='#0082c8' align=center><font   size=1>Ticket#</font></th></tr>\n";
		 echo "<tr><td><font size=1>$account</font></td><td><font size=1>$etr</font></td><td><font size=1>$line</font></td>\n";
		 echo "</table>";
	 }
	 echo "<br>\n";
}
	...
	for($x = 0 ; $x < mysqli_num_rows($resultID) ; $x++){
  			 $row = mysqli_fetch_assoc($resultID);
				 ...
				 if ($etr != NULL) {
	 			 ...
	 			 $current = $current . "<tr><td><font size=1>$town</font></td><td><font size=1>$out</font></td><td><font size=1>$off</font></td><td><font size=1>$etr</font></td><td><font size=1>$tk</font></td></tr>\n";
	}
  echo "<b>Total Outages: $outage_count</b><br>";
  echo "<b>Total Members Out: $total</b><br>\n";
  echo "<b>Current Outages By Town:</b><br>";
  echo "<table cellpadding=3>\n";
  echo "<tr><th bgcolor='#0082c8' align=center ><font   size=1>Town</font></th><th bgcolor='#0082c8'><font   size=1>#M</font></td><th bgcolor='#0082c8' align=center><font   size=1>Time Off</font></th><th bgcolor='#0082c8' align=center><font   size=1>Estimated<br>Restoration Time</font></th><th bgcolor='#0082c8' align=center><font   size=1>Ticket#</font></th></tr>\n";
  echo $current;
  echo "</table>";
}
...
?>
Recent Outages (last 24 hours)<br>
<Table border='0' cellspacing='1' cellpadding='3' width=598>   <thead > 
<tr><th bgcolor='#0082c8' ><font  size=1>Town</font></th><th bgcolor='#0082c8' ><font  size=1>#M</font></th><th bgcolor='#0082c8'><font  size=1>Time Off</font></th><th bgcolor='#0082c8'><font  size=1>Time on</font></th><th bgcolor='#0082c8'><font  size=1>Cause</font></th><th bgcolor='#0082c8'><font  size=1>Desc.</font></th><th bgcolor='#0082c8'><font  size=1>Ticket#</font></th></tr>
</thead>
...
for($x = 0 ; $x < mysqli_num_rows($resultID) ; $x++){
   ...
   $numout = $row['numout'];
	 ...
	 echo "<tr><td><font size=1>$town</font></td><td><font size=1>$numout</font></td><td><font size=1>$off</font></td><td><font size=1>$on</font></td><td><font size=1>$cause</font></td><td><font size=1>$desc</font></td><td><font size=1>$tk</font></td></tr>\n";
	 }
echo "</table>&nbsp;\n";
if (mysqli_num_rows($resultID) == 0) {
